		...
		public static function settings_init() {
			...
			add_settings_field(
				...
				array(
					...
					'description' => 'The default handlbars template to use for the angular heading. See <a href="https://github.com/UCF/UCF-Degree-Search-Plugin/wiki/Title-and-Heading-Templates" target="_blank">this page</a> for more information on templates.',
					'type'        => 'wysiwyg'
				)
			);
		}
